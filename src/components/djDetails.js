...
class DJDetails extends React.Component {
  ...
  render() {
    ...
    const comment = <div className={styles.comment}>
      <h4>精彩评论</h4>
      <ul>
        {details.commentDatas.map((item, index) => <li key={index}>
          <div>
            <h3>
    ...
    const detail = <div className={styles.show}>
    ...
    return (
      <div className={styles.details}>
        <h3 className={styles.header}><span className={styles.back} onClick={() => this.back()}>←</span>电台</h3>
        <div className={styles.top} style={{ backgroundImage: `url(${details.picUrl})` }}>
